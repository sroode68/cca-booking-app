    ...
    return(
        <div className="room-info">
           <Link to="/" style={{
            ...
            <h1>Book a time!</h1>
                {showButton9 && <button onClick={() => {updateTime9("room2")}}>9:00</button>}
                {showButton10 && <button onClick={() => {updateTime10("room2")}}>10:00</button>}
                {showButton11 && <button onClick={() => {updateTime11("room2")}}>11:00</button>}
                {showButton12 && <button onClick={() => {updateTime12("room2")}}>12:00</button>}
                {showButton1 && <button onClick={() => {updateTime1("room2")}}>1:00</button>}
                {showButton2 && <button onClick={() => {updateTime2("room2")}}>2:00</button>}
                {showButton3 && <button onClick={() => {updateTime3("room2")}}>3:00</button>}            
            </div>
        </div>
    );
}
