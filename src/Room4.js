    ...
    return(
        ...
        <div className="room-info">
           <Link to="/" style={{
            ...
            <h1>K101B</h1>
            <h2>The room behind room K101A</h2>
            ...
            <div className="timeslot">
                ...
                {showButton9 && <button onClick={() => {updateTime9("room4")}}>9:00</button>}
                {showButton10 && <button onClick={() => {updateTime10("room4")}}>10:00</button>}
                {showButton11 && <button onClick={() => {updateTime11("room4")}}>11:00</button>}
                {showButton12 && <button onClick={() => {updateTime12("room4")}}>12:00</button>}
                {showButton1 && <button onClick={() => {updateTime1("room4")}}>1:00</button>}
                {showButton2 && <button onClick={() => {updateTime2("room4")}}>2:00</button>}
                {showButton3 && <button onClick={() => {updateTime3("room4")}}>3:00</button>}              
            </div>
        </div>
    );
}
